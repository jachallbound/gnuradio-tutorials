...
class hierblock(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Hier Block Tutorial", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Hier Block Tutorial")
        ...
        self._frequency_win = GrRangeWidget(self._frequency_range, self.set_frequency, "Frequency Control", "counter_slider", float, QtCore.Qt.Horizontal, "value")
