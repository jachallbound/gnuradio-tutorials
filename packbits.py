...
class packbits(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Pack Bits Flowgraph", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Pack Bits Flowgraph")
        ...
        self.connect((self.blocks_throttle_0, 0), (self.blocks_char_to_float_2, 0))
