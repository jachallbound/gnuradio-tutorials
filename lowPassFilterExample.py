...
class lowPassFilterExample(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lowPassFilterExample")
        ...
        # Connections
        ##################################################
        self.connect((self.analog_fastnoise_source_x_0, 0), (self.low_pass_filter_0_0_0, 0))
        ...
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_throttle_0_0, 0))
        self.connect((self.low_pass_filter_0_0_0, 0), (self.blocks_multiply_xx_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0_0_0.set_taps(firdes.low_pass(1, self.samp_rate, (self.samp_rate/8), (self.samp_rate/16), window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=lowPassFilterExample, options=None):
