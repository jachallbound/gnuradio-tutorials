...
class streamsAndVectors(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Streams and Vectors", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Streams and Vectors")
        ...
        self.settings = Qt.QSettings("GNU Radio", "streamsAndVectors")
...
def main(top_block_cls=streamsAndVectors, options=None):
